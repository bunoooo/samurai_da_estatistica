...
NpcReaperSprites = [(x, 0, 48, 57) for x in range(0, 240, 48)]

class ReaperNpc(pygame.sprite.Sprite):
    def __init__(self, position, faceRight=True, nome="Ceifador"):
        super().__init__()
        self.idleSpriteSheet = SpriteSheet(reaper_path + "HostileIdleReaper-Sheet.png", NpcReaperSprites)
